...
echo "# 	docker run -p 8000:8000 -v \$(pwd)/data:/data splunk-lab "
echo "# "
echo "# Persis data, and mount current directory as /mnt:"
echo "# 	docker run -p 8000:8000 -v \$(pwd)/data:/data -v \$(pwd):/mnt splunk-lab "
echo "# "
echo "# Persist data, mount current directory as /mnt, and spawn interactive shell: "
echo "# 	docker run -p 8000:8000 -v \$(pwd)/data:/data -v \$(pwd):/mnt -it splunk-lab bash "
echo "# "
echo "# Persist data and ingest /var/log/:"
echo "# 	docker run -p 8000:8000 -v \$(pwd)/data:/data -v /var/log:/logs splunk-lab "
echo "# "
echo "# Persist data, ingest /var/log/, and run in background:"
echo "# 	docker run -p 8000:8000 -v \$(pwd)/data:/data -v -d \$(pwd):/mnt splunk-lab "
echo "# "
echo "# "
